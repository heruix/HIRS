...
public class PcrInfoShort {
     ...
     * @return byte array containing the digest
     */
    public final byte[] getCalculatedDigestTpmV1p2(final MessageDigest messageDigest) {
        byte[] computedDigest;
     ...
     * @return byte array containing the digest
     */
    public final byte[] getCalculatedDigestTpmV2p0(final MessageDigest messageDigest) {
